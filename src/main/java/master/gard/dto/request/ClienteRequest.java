...
public record ClienteRequest(
        ...
        @Schema(description = "Nome completo do cliente", examples = "João da Silva", required = true)
        @NotNull @NotBlank String nome,

        @Schema(description = "CPF (11 dígitos) ou CNPJ (14 caracteres)", examples = "12345678901", required = true)
        @NotNull @NotBlank @CpfCnpj String documento,

        @Schema(description = "Endereço de e-mail válido e único", examples = "joao@email.com", required = true)
        @NotNull @NotBlank @Email String email,

        @Schema(description = "Perfil de risco do investidor", examples = "CONSERVADOR", required = true,
